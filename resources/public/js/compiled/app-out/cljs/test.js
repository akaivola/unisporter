...
var args39040 = [];
var len__26441__auto___39044 = arguments.length;
var i__26442__auto___39045 = (0);
while(true){
if((i__26442__auto___39045 < len__26441__auto___39044)){
args39040.push((arguments[i__26442__auto___39045]));

var G__39046 = (i__26442__auto___39045 + (1));
i__26442__auto___39045 = G__39046;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args39040.length)].join('')));
...
return cljs.core.assoc.call(null,G__39043,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__39043;
}
});
...
var len__26441__auto___39051 = arguments.length;
var i__26442__auto___39052 = (0);
while(true){
if((i__26442__auto___39052 < len__26441__auto___39051)){
args__26448__auto__.push((arguments[i__26442__auto___39052]));

var G__39053 = (i__26442__auto___39052 + (1));
i__26442__auto___39052 = G__39053;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq39048){
var G__39049 = cljs.core.first.call(null,seq39048);
var seq39048__$1 = cljs.core.next.call(null,seq39048);
var G__39050 = cljs.core.first.call(null,seq39048__$1);
var seq39048__$2 = cljs.core.next.call(null,seq39048__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__39049,G__39050,seq39048__$2);
});
...
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__39057,map__39057__$1,file,line,column){
return (function (p1__39054_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__39054_SHARP_));
});})(map__39057,map__39057__$1,file,line,column))
...
var temp__4657__auto___39059 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___39059)){
var message_39060 = temp__4657__auto___39059;
cljs.core.println.call(null,message_39060);
} else {
}
...
var temp__4657__auto___39061 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___39061)){
var message_39062 = temp__4657__auto___39061;
cljs.core.println.call(null,message_39062);
} else {
}
...
var G__39072 = exception.stack;
var G__39072__$1 = (((G__39072 == null))?null:clojure.string.split_lines.call(null,G__39072));
var G__39072__$2 = (((G__39072__$1 == null))?null:cljs.core.get.call(null,G__39072__$1,depth));
if((G__39072__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__39072__$2);
}
} else {
...
var vec__39073 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__39073,(0),null);
var column = cljs.core.nth.call(null,vec__39073,(1),null);
var vec__39076 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__39076,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__39076,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__39076,(2),null);
...
var m__$1 = (function (){var G__39080 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__39080) {
case "fail":
...
var G__39086 = (function (){var G__39085 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__39085);
} else {
return G__39085;
}
})();
...
return cljs.core.vary_meta.call(null,G__39088,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var G__39092 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__39092) {
...
var vec__39097 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__39097,(0),null);
var types = vec__39097;
...
return cljs.core.map.call(null,(function (p__39109){
var vec__39110 = p__39109;
var ns = cljs.core.nth.call(null,vec__39110,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__39110,(1),null);
return ((function (vec__39110,ns,vars__$1){
return (function (){
...
var G__39113 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__39113) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__39113,env,once_fixtures,each_fixtures,vec__39110,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__39113,env,once_fixtures,each_fixtures,vec__39110,ns,vars__$1){
return (function (){
var seq__39114 = cljs.core.seq.call(null,vars__$1);
var chunk__39115 = null;
var count__39116 = (0);
var i__39117 = (0);
while(true){
if((i__39117 < count__39116)){
var v = cljs.core._nth.call(null,chunk__39115,i__39117);
var temp__4657__auto___39119 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___39119)){
var t_39120 = temp__4657__auto___39119;
each_fixture_fn.call(null,((function (seq__39114,chunk__39115,count__39116,i__39117,t_39120,temp__4657__auto___39119,v,each_fixture_fn,G__39113,env,once_fixtures,each_fixtures,vec__39110,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_39120)));
});})(seq__39114,chunk__39115,count__39116,i__39117,t_39120,temp__4657__auto___39119,v,each_fixture_fn,G__39113,env,once_fixtures,each_fixtures,vec__39110,ns,vars__$1))
);
} else {
}

var G__39121 = seq__39114;
var G__39122 = chunk__39115;
var G__39123 = count__39116;
var G__39124 = (i__39117 + (1));
seq__39114 = G__39121;
chunk__39115 = G__39122;
count__39116 = G__39123;
i__39117 = G__39124;
continue;
} else {
...
var c__26147__auto__ = cljs.core.chunk_first.call(null,seq__39114__$1);
var G__39125 = cljs.core.chunk_rest.call(null,seq__39114__$1);
var G__39126 = c__26147__auto__;
var G__39127 = cljs.core.count.call(null,c__26147__auto__);
var G__39128 = (0);
seq__39114 = G__39125;
chunk__39115 = G__39126;
count__39116 = G__39127;
i__39117 = G__39128;
continue;
} else {
var v = cljs.core.first.call(null,seq__39114__$1);
var temp__4657__auto___39129__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___39129__$1)){
var t_39130 = temp__4657__auto___39129__$1;
each_fixture_fn.call(null,((function (seq__39114,chunk__39115,count__39116,i__39117,t_39130,temp__4657__auto___39129__$1,v,seq__39114__$1,temp__4657__auto__,each_fixture_fn,G__39113,env,once_fixtures,each_fixtures,vec__39110,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_39130)));
});})(seq__39114,chunk__39115,count__39116,i__39117,t_39130,temp__4657__auto___39129__$1,v,seq__39114__$1,temp__4657__auto__,each_fixture_fn,G__39113,env,once_fixtures,each_fixtures,vec__39110,ns,vars__$1))
);
} else {
}

var G__39131 = cljs.core.next.call(null,seq__39114__$1);
var G__39132 = null;
var G__39133 = (0);
var G__39134 = (0);
seq__39114 = G__39131;
...
});})(each_fixture_fn,G__39113,env,once_fixtures,each_fixtures,vec__39110,ns,vars__$1))
);
});})(each_fixture_fn,G__39113,env,once_fixtures,each_fixtures,vec__39110,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1489150135489