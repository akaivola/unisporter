...
return [cljs.core.str((function (){var pred__27195 = cljs.core.instance_QMARK_;
var expr__27196 = reactive_val;
if(cljs.core.truth_(pred__27195.call(null,reagent.ratom.RAtom,expr__27196))){
return "ra";
} else {
if(cljs.core.truth_(pred__27195.call(null,reagent.ratom.RCursor,expr__27196))){
return "rc";
} else {
if(cljs.core.truth_(pred__27195.call(null,reagent.ratom.Reaction,expr__27196))){
return "rx";
} else {
if(cljs.core.truth_(pred__27195.call(null,reagent.ratom.Track,expr__27196))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1489150125196