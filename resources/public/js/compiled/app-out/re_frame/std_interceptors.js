...
var vec__27968_27971 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_27972 = cljs.core.nth.call(null,vec__27968_27971,(0),null);
var only_after_27973 = cljs.core.nth.call(null,vec__27968_27971,(1),null);
var db_changed_QMARK__27974 = (cljs.core.some_QMARK_.call(null,only_before_27972)) || (cljs.core.some_QMARK_.call(null,only_after_27973));
if(db_changed_QMARK__27974){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_27972);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_27973);
...
var map__27981 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__27981__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__27981__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__27989 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__27989__$1;
var event = cljs.core.get.call(null,map__27989__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__26441__auto___27992 = arguments.length;
var i__26442__auto___27993 = (0);
while(true){
if((i__26442__auto___27993 < len__26441__auto___27992)){
args__26448__auto__.push((arguments[i__26442__auto___27993]));

var G__27994 = (i__26442__auto___27993 + (1));
i__26442__auto___27993 = G__27994;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq27991){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq27991));
});
...
var args__26448__auto__ = [];
var len__26441__auto___28000 = arguments.length;
var i__26442__auto___28001 = (0);
while(true){
if((i__26442__auto___28001 < len__26441__auto___28000)){
args__26448__auto__.push((arguments[i__26442__auto___28001]));

var G__28002 = (i__26442__auto___28001 + (1));
i__26442__auto___28001 = G__28002;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__27995_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__27996_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__27996_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq27997){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__27998,G__27999,seq27997__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1489150127041