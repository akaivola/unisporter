...
var G__26999 = o;
(G__26999[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__27000__delegate = function (args){
...
return G__27000__delegate.call(this,args);};
...
return G__27000__delegate(args);
});
...
var G__27008 = jsprops;
(G__27008["defaultValue"] = value);

(G__27008["onChange"] = ((function (G__27008,v,value,on_change){
return (function (p1__27005_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__27005_SHARP_);
});})(G__27008,v,value,on_change))
);

(G__27008["ref"] = ((function (G__27008,v,value,on_change){
return (function (p1__27006_SHARP_){
return (this$["cljsInputElement"] = p1__27006_SHARP_);
});})(G__27008,v,value,on_change))
);
...
var vec__27015 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__27015,(0),null);
var id = cljs.core.nth.call(null,vec__27015,(1),null);
var class$ = cljs.core.nth.call(null,vec__27015,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___27020 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___27020 == null)){
} else {
var key_27021 = temp__4661__auto___27020;
(jsprops["key"] = key_27021);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__27023 = (new reagent.impl.template.NativeWrapper());
(G__27023["name"] = c);
...
var len__26441__auto___27029 = arguments.length;
var i__26442__auto___27030 = (0);
while(true){
if((i__26442__auto___27030 < len__26441__auto___27029)){
args__26448__auto__.push((arguments[i__26442__auto___27030]));

var G__27031 = (i__26442__auto___27030 + (1));
i__26442__auto___27030 = G__27031;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq27027){
var G__27028 = cljs.core.first.call(null,seq27027);
var seq27027__$1 = cljs.core.next.call(null,seq27027);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__27028,seq27027__$1);
});
...
break;
default:
var G__27035 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__27035;
continue;
...
var n__26251__auto___27038 = a.length;
var i_27039 = (0);
while(true){
if((i_27039 < n__26251__auto___27038)){
(a[i_27039] = reagent.impl.template.as_element.call(null,(a[i_27039])));
...
var a = cljs.core.into_array.call(null,s);
var n__26251__auto___27041 = a.length;
var i_27042 = (0);
while(true){
if((i_27042 < n__26251__auto___27041)){
var val_27043 = (a[i_27042]);
if((cljs.core.vector_QMARK_.call(null,val_27043)) && ((reagent.impl.template.key_from_vec.call(null,val_27043) == null))){
(o["no-key"] = true);
} else {
}

(a[i_27042] = reagent.impl.template.as_element.call(null,val_27043));

var G__27044 = (i_27042 + (1));
i_27042 = G__27044;
continue;
} else {
}
...
var ctx = ({});
var vec__27048 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__27048,(0),null);
var derefed = cljs.core.nth.call(null,vec__27048,(1),null);
...
var G__27052 = (cljs.core.count.call(null,argv) - first_child);
switch (G__27052) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__27052){
...
//# sourceMappingURL=template.js.map?rel=1489150124912