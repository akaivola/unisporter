...
var args49882 = [];
var len__26441__auto___49894 = arguments.length;
var i__26442__auto___49895 = (0);
while(true){
if((i__26442__auto___49895 < len__26441__auto___49894)){
args49882.push((arguments[i__26442__auto___49895]));

var G__49901 = (i__26442__auto___49895 + (1));
i__26442__auto___49895 = G__49901;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args49882.length)].join('')));
...
var G__49891 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__49891,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__49891;
}
});
...
var or__25333__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__26441__auto___49927 = arguments.length;
var i__26442__auto___49928 = (0);
while(true){
if((i__26442__auto___49928 < len__26441__auto___49927)){
args__26448__auto__.push((arguments[i__26442__auto___49928]));

var G__49929 = (i__26442__auto___49928 + (1));
i__26442__auto___49928 = G__49929;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__26449__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq49920){
var G__49921 = cljs.core.first.call(null,seq49920);
var seq49920__$1 = cljs.core.next.call(null,seq49920);
var G__49922 = cljs.core.first.call(null,seq49920__$1);
var seq49920__$2 = cljs.core.next.call(null,seq49920__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__49921,G__49922,seq49920__$2);
});
...
var file = cljs.core.get.call(null,map__49970__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__49970__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__49970__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__49970,map__49970__$1,file,line,column){
return (function (p1__49958_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__49958_SHARP_));
});})(map__49970,map__49970__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__26261__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__26261__auto__,prefer_table__26262__auto__,method_cache__26263__auto__,cached_hierarchy__26264__auto__,hierarchy__26265__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__25333__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__25333__auto__)){
return or__25333__auto__;
} else {
...
var temp__4657__auto___50021 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___50021)){
var message_50022 = temp__4657__auto___50021;
cljs.core.println.call(null,message_50022);
} else {
}
...
var temp__4657__auto___50023 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___50023)){
var message_50024 = temp__4657__auto___50023;
cljs.core.println.call(null,message_50024);
} else {
}
...
var temp__4655__auto__ = (function (){var and__25321__auto__ = typeof exception.stack === 'string';
if(and__25321__auto__){
var G__50045 = exception.stack;
var G__50045__$1 = (((G__50045 == null))?null:clojure.string.split_lines.call(null,G__50045));
var G__50045__$2 = (((G__50045__$1 == null))?null:cljs.core.get.call(null,G__50045__$1,depth));
if((G__50045__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__50045__$2);
}
} else {
...
var vec__50047 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__50047,(0),null);
var column = cljs.core.nth.call(null,vec__50047,(1),null);
var vec__50050 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__50050,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__50050,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__50050,(2),null);
...
var m__$1 = (function (){var G__50054 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__50054) {
case "fail":
...
var G__50082 = (function (){var G__50075 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__50075);
} else {
return G__50075;
}
})();
...
return cljs.core.vary_meta.call(null,G__50084,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var G__50094 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__50094) {
...
var vec__50111 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__50111,(0),null);
var types = vec__50111;
...
return cljs.core.map.call(null,(function (p__50137){
var vec__50138 = p__50137;
var ns = cljs.core.nth.call(null,vec__50138,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__50138,(1),null);
return ((function (vec__50138,ns,vars__$1){
return (function (){
...
var G__50141 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__50141) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__50141,env,once_fixtures,each_fixtures,vec__50138,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__50141,env,once_fixtures,each_fixtures,vec__50138,ns,vars__$1){
return (function (){
var seq__50142 = cljs.core.seq.call(null,vars__$1);
var chunk__50143 = null;
var count__50144 = (0);
var i__50145 = (0);
while(true){
if((i__50145 < count__50144)){
var v = cljs.core._nth.call(null,chunk__50143,i__50145);
var temp__4657__auto___50163 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___50163)){
var t_50166 = temp__4657__auto___50163;
each_fixture_fn.call(null,((function (seq__50142,chunk__50143,count__50144,i__50145,t_50166,temp__4657__auto___50163,v,each_fixture_fn,G__50141,env,once_fixtures,each_fixtures,vec__50138,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_50166)));
});})(seq__50142,chunk__50143,count__50144,i__50145,t_50166,temp__4657__auto___50163,v,each_fixture_fn,G__50141,env,once_fixtures,each_fixtures,vec__50138,ns,vars__$1))
);
} else {
}

var G__50171 = seq__50142;
var G__50172 = chunk__50143;
var G__50173 = count__50144;
var G__50174 = (i__50145 + (1));
seq__50142 = G__50171;
chunk__50143 = G__50172;
count__50144 = G__50173;
i__50145 = G__50174;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__50142);
if(temp__4657__auto__){
var seq__50142__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__50142__$1)){
var c__26147__auto__ = cljs.core.chunk_first.call(null,seq__50142__$1);
var G__50176 = cljs.core.chunk_rest.call(null,seq__50142__$1);
var G__50177 = c__26147__auto__;
var G__50178 = cljs.core.count.call(null,c__26147__auto__);
var G__50179 = (0);
seq__50142 = G__50176;
chunk__50143 = G__50177;
count__50144 = G__50178;
i__50145 = G__50179;
continue;
} else {
var v = cljs.core.first.call(null,seq__50142__$1);
var temp__4657__auto___50180__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___50180__$1)){
var t_50181 = temp__4657__auto___50180__$1;
each_fixture_fn.call(null,((function (seq__50142,chunk__50143,count__50144,i__50145,t_50181,temp__4657__auto___50180__$1,v,seq__50142__$1,temp__4657__auto__,each_fixture_fn,G__50141,env,once_fixtures,each_fixtures,vec__50138,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_50181)));
});})(seq__50142,chunk__50143,count__50144,i__50145,t_50181,temp__4657__auto___50180__$1,v,seq__50142__$1,temp__4657__auto__,each_fixture_fn,G__50141,env,once_fixtures,each_fixtures,vec__50138,ns,vars__$1))
);
} else {
}

var G__50190 = cljs.core.next.call(null,seq__50142__$1);
var G__50191 = null;
var G__50192 = (0);
var G__50193 = (0);
seq__50142 = G__50190;
chunk__50143 = G__50191;
count__50144 = G__50192;
i__50145 = G__50193;
continue;
}
} else {
...
});})(each_fixture_fn,G__50141,env,once_fixtures,each_fixtures,vec__50138,ns,vars__$1))
);
});})(each_fixture_fn,G__50141,env,once_fixtures,each_fixtures,vec__50138,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1489150142663