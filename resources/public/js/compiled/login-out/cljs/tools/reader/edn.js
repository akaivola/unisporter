...
var args45838 = [];
var len__26441__auto___45842 = arguments.length;
var i__26442__auto___45843 = (0);
while(true){
if((i__26442__auto___45843 < len__26441__auto___45842)){
args45838.push((arguments[i__26442__auto___45843]));

var G__45844 = (i__26442__auto___45843 + (1));
i__26442__auto___45843 = G__45844;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args45838.length)].join('')));
...
if(cljs.core.truth_((function (){var and__25321__auto__ = validate_leading_QMARK_;
...
var G__45848 = (function (){var G__45841 = sb;
G__45841.append(cljs.tools.reader.reader_types.read_char.call(null,rdr));

return G__45841;
})();
var G__45849 = cljs.tools.reader.reader_types.peek_char.call(null,rdr);
sb = G__45848;
ch = G__45849;
continue;
}
...
var temp__4655__auto____$2 = cljs.tools.reader.edn.read_tagged.call(null,(function (){var G__45851 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__45851,ch);
...
var args45863 = [];
var len__26441__auto___45878 = arguments.length;
var i__26442__auto___45879 = (0);
while(true){
if((i__26442__auto___45879 < len__26441__auto___45878)){
args45863.push((arguments[i__26442__auto___45879]));

var G__45880 = (i__26442__auto___45879 + (1));
i__26442__auto___45879 = G__45880;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args45863.length)].join('')));
...
var or__25333__auto____$1 = cljs.tools.reader.edn.macros.call(null,ch);
...
var G__46027 = ((!((mret === rdr)))?cljs.core.conj_BANG_.call(null,a,mret):a);
a = G__46027;
continue;
} else {
var o = cljs.tools.reader.edn.read.call(null,(function (){var G__46012 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__46012,ch);

return G__46012;
})(),true,null,opts);
var G__46031 = ((!((o === rdr)))?cljs.core.conj_BANG_.call(null,a,o):a);
a = G__46031;
continue;
}
}
...
var sb = (function (){var G__46067 = (new goog.string.StringBuffer());
G__46067.append(initch);
...
var G__46072 = (function (){var G__46068 = sb;
G__46068.append(ch);

return G__46068;
})();
var G__46073 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__46072;
ch = G__46073;
continue;
}
...
while(true){
var G__46209 = ch;
if(cljs.core._EQ_.call(null,null,G__46209)){
return cljs.tools.reader.reader_types.reader_error.call(null,reader,"EOF while reading string");
} else {
if(cljs.core._EQ_.call(null,"\\",G__46209)){
var G__46220 = (function (){var G__46211 = sb;
G__46211.append(cljs.tools.reader.edn.escape_char.call(null,sb,reader));

return G__46211;
})();
var G__46221 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__46220;
ch = G__46221;
continue;
} else {
...
var G__46230 = (function (){var G__46214 = sb;
G__46214.append(ch);

return G__46214;
})();
var G__46231 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__46230;
ch = G__46231;
continue;
...
break;
default:
var or__25333__auto__ = (function (){var temp__4657__auto____$1 = cljs.tools.reader.impl.commons.parse_symbol.call(null,token);
...
return cljs.core._conj.call(null,(function (){var x__26170__auto____$1 = cljs.tools.reader.edn.read.call(null,rdr,true,null,opts);
...
var G__46290 = rdr;
cljs.tools.reader.edn.read.call(null,G__46290,true,null,true);
...
var temp__4655__auto__ = (function (){var G__46293 = token;
var G__46293__$1 = (((G__46293 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__46293));
if((G__46293__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__46293__$1);
}
})();
if(cljs.core.truth_(temp__4655__auto__)){
...
var temp__4655__auto__ = (function (){var or__25333__auto__ = cljs.core.get.call(null,new cljs.core.Keyword(null,"readers","readers",-2118263030).cljs$core$IFn$_invoke$arity$1(opts),tag);
if(cljs.core.truth_(or__25333__auto__)){
return or__25333__auto__;
} else {
...
var args46317 = [];
var len__26441__auto___46336 = arguments.length;
var i__26442__auto___46337 = (0);
while(true){
if((i__26442__auto___46337 < len__26441__auto___46336)){
args46317.push((arguments[i__26442__auto___46337]));

var G__46338 = (i__26442__auto___46337 + (1));
i__26442__auto___46337 = G__46338;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args46317.length)].join('')));
...
cljs.tools.reader.edn.read.cljs$core$IFn$_invoke$arity$2 = (function (p__46323,reader){
...
var opts = map__46324__$1;
var eof = cljs.core.get.call(null,map__46324__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
...
}catch (e46327){if((e46327 instanceof Error)){
var e = e46327;
...
var args46355 = [];
var len__26441__auto___46360 = arguments.length;
var i__26442__auto___46362 = (0);
while(true){
if((i__26442__auto___46362 < len__26441__auto___46360)){
args46355.push((arguments[i__26442__auto___46362]));

var G__46363 = (i__26442__auto___46362 + (1));
i__26442__auto___46362 = G__46363;
continue;
} else {
}
break;
...
//# sourceMappingURL=edn.js.map?rel=1489150141505