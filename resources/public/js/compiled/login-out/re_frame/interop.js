...
return [cljs.core.str((function (){var pred__48981 = cljs.core.instance_QMARK_;
var expr__48982 = reactive_val;
if(cljs.core.truth_(pred__48981.call(null,reagent.ratom.RAtom,expr__48982))){
return "ra";
} else {
if(cljs.core.truth_(pred__48981.call(null,reagent.ratom.RCursor,expr__48982))){
return "rc";
} else {
if(cljs.core.truth_(pred__48981.call(null,reagent.ratom.Reaction,expr__48982))){
return "rx";
} else {
if(cljs.core.truth_(pred__48981.call(null,reagent.ratom.Track,expr__48982))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1489150142256