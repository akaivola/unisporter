...
var vec__49578_49588 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_49589 = cljs.core.nth.call(null,vec__49578_49588,(0),null);
var only_after_49590 = cljs.core.nth.call(null,vec__49578_49588,(1),null);
var db_changed_QMARK__49591 = (cljs.core.some_QMARK_.call(null,only_before_49589)) || (cljs.core.some_QMARK_.call(null,only_after_49590));
if(db_changed_QMARK__49591){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_49589);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_49590);
...
var map__49612 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__49612__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__49612__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__49630 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__49630__$1;
var event = cljs.core.get.call(null,map__49630__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__26441__auto___49654 = arguments.length;
var i__26442__auto___49655 = (0);
while(true){
if((i__26442__auto___49655 < len__26441__auto___49654)){
args__26448__auto__.push((arguments[i__26442__auto___49655]));

var G__49656 = (i__26442__auto___49655 + (1));
i__26442__auto___49655 = G__49656;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__26449__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq49651){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq49651));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__25333__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__26448__auto__ = [];
var len__26441__auto___49699 = arguments.length;
var i__26442__auto___49702 = (0);
while(true){
if((i__26442__auto___49702 < len__26441__auto___49699)){
args__26448__auto__.push((arguments[i__26442__auto___49702]));

var G__49707 = (i__26442__auto___49702 + (1));
i__26442__auto___49702 = G__49707;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__26449__auto__);
});
...
return (function (p1__49693_SHARP_){
return cljs.core.get_in.call(null,new_db,p1__49693_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__49694_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__49694_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq49695){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__49696,G__49697,seq49695__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1489150142506