...
return cljs.core.reduce.call(null,(function (result,p__49350){
var vec__49351 = p__49350;
var k = cljs.core.nth.call(null,vec__49351,(0),null);
var v = cljs.core.nth.call(null,vec__49351,(1),null);
...
var vec__49375 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__49375,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__49375,(1),null);
var ab = cljs.core.nth.call(null,vec__49375,(2),null);
...
var args49403 = [];
var len__26441__auto___49410 = arguments.length;
var i__26442__auto___49411 = (0);
while(true){
if((i__26442__auto___49411 < len__26441__auto___49410)){
args49403.push((arguments[i__26442__auto___49411]));

var G__49412 = (i__26442__auto___49411 + (1));
i__26442__auto___49411 = G__49412;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args49403.length)].join('')));
...
var x__25996__auto__ = (((x == null))?null:x);
var m__25997__auto__ = (clojure.data.equality_partition[goog.typeOf(x__25996__auto__)]);
if(!((m__25997__auto__ == null))){
return m__25997__auto__.call(null,x);
} else {
var m__25997__auto____$1 = (clojure.data.equality_partition["_"]);
if(!((m__25997__auto____$1 == null))){
return m__25997__auto____$1.call(null,x);
} else {
...
var x__25996__auto__ = (((a == null))?null:a);
var m__25997__auto__ = (clojure.data.diff_similar[goog.typeOf(x__25996__auto__)]);
if(!((m__25997__auto__ == null))){
return m__25997__auto__.call(null,a,b);
} else {
var m__25997__auto____$1 = (clojure.data.diff_similar["_"]);
if(!((m__25997__auto____$1 == null))){
return m__25997__auto____$1.call(null,a,b);
} else {
...
return (function (){var G__49478 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);
switch (G__49478) {
case "atom":
...
//# sourceMappingURL=data.js.map?rel=1489150142439